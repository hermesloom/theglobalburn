    ...
    <><PersonCommandBox /><DataTable
      ...
      columns={[
        ...
        },
        {
          key: "price",
          label: "Price",
          render: (_, { price, price_currency }) => formatMoney(price, price_currency),
        },
      ]}
      globalActions={[
        {
          ...
          onClick: {
            prompt: () => prompt("Enter the details of the membership to be issued.", [
              {
                key: "email",
                label: "Email",
              ...
              },
              {
                key: "birthdate",
                label: "Date of birth",
                validate: (birthdate) => /^\d{4}-\d{2}-\d{2}$/.test(birthdate),
              },
            ]),
        ...
        },
        {
          ...
          condition: () => project?.burn_config.current_stage === BurnStage.LotteryClosed,
          onClick: async () => {
            await apiPost(
        ...
        },
        {
          ...
          condition: () => project?.burn_config.current_stage ===
